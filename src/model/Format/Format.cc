...
int Format::GetHour(const std::string& time) {
...
std::string Format::SumTime(const std::string& time1, const std::string& time2) {
...
std::string Format::DiffTime(const std::string& time1, const std::string& time2) {
    if (time1.empty() || time2.empty()) {
        return "";
    }
